* testing the original code base
...
def new_countPlayers(dbname, table_name):
    ...
    return int(row_item[0])
#+END_SRC
** tests 1-7 plus specs for new functionality
   :PROPERTIES:
...
|       17 | soccer          |     2 |    9 |   13 |          1 |          1 |
|       18 | soccer          |     2 |   12 |   16 |          0 |          1 |
|       19 | soccer          |     2 |   10 |   15 |          1 |          0 |
|       20 | soccer          |     2 |   11 |   14 |          0 |          1 |
|       21 | soccer          |     3 |   16 |    9 |          1 |          0 |
|       22 | soccer          |     3 |   13 |   12 |          0 |          1 |
|       23 | soccer          |     3 |   14 |   10 |          1 |          0 |
|       24 | soccer          |     3 |   15 |   11 |          0 |          1 |
*** select * from matchez
#+BEGIN_SRC sql :engine postgresql :database tourney_practice
...
|-----------+-------------+-----------------+------+--------+-------+--------+-----|
|         1 | a           | tennis          |    5 |      0 |     0 |     15 |  15 |
|         2 | b           | tennis          |    3 |      2 |     0 |      9 |  12 |
|         3 | c           | tennis          |    1 |      4 |     0 |      3 |   9 |
|         4 | d           | tennis          |    3 |      2 |     0 |      9 |  12 |
|         5 | e           | tennis          |    2 |      3 |     0 |      6 |  18 |
|         6 | f           | tennis          |    2 |      3 |     0 |      6 |  12 |
|         7 | g           | tennis          |    0 |      5 |     0 |      0 |  15 |
|         8 | h           | tennis          |    4 |      1 |     0 |     12 |  15 |
